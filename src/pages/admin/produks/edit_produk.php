...
<body>
    <div class="container-scroller">
        ...
        $product = null;
        if ($id !== null) {
            $stmt = $pdo->prepare('SELECT nama_produk, stok, harga FROM produks WHERE id_produk = :id_produk');
            $stmt->execute(['id_produk' => $id]);
            $product = $stmt->fetch();
        }
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <form method="POST" action="update">
                        <table border="1">
                            <input type="hidden" name="id_produk" value="<?php echo htmlspecialchars($id); ?>">
                            <tr>
                                <td>Nama Produk</td>
                                <td><input type="text" class="form-control form-control-sm" name="nama_produk" value="<?php echo htmlspecialchars($product['nama_produk'] ?? ''); ?>"></td>
                            </tr>
                            <tr>
                                <td>Stok</td>
                                <td><input type="text" class="form-control form-control-sm" name="stok" value="<?php echo htmlspecialchars($product['stok'] ?? ''); ?>"></td>
                            </tr>
                            <tr>
                                <td>Harga</td>
                                <td><input type="text" class="form-control form-control-sm" name="harga" value="<?php echo htmlspecialchars($product['harga'] ?? ''); ?>"></td>
                            </tr>
                            <tr>
