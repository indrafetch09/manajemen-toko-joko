            ...
            <div class="col-xl-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="text-muted">Audience to which the users belonged while on the current date Audience to which
                  ...
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-wrap align-items-baseline">
                        <h2 class="me-3">33,956</h2>
                        <i class="mdi mdi-arrow-up me-1 text-danger"></i><span>
                          <p class="mb-0 text-danger fw-medium">+2.12%</p>
                        </span>
                      </div>
                ...
                <div class="col-md-6 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-wrap align-items-baseline">
                        <h2 class="me-3">50.36%</h2>
                        <i class="mdi mdi-arrow-up me-1 text-success"></i><span>
                          <p class="mb-0 text-success fw-medium">+9.12%</p>
                        </span>
                      </div>
                      <p class="mb-0 text-muted">Total users world wide</p>
                    </div>
                ...
                <div class="col-md-12 stretch-card">
                  <div class="card">
                    <div class="card-body">
                      ...
                      <p class="text-muted mb-2">Watching ice melt. This is fun. Only you could make those words cute.
                      </p>
                      <div class="row mt-4">
                  ...
                  <div class="d-flex justify-content-between align-items-md-end flex-wrap">
                    ...
                    <div class="dropdown mb-3 mb-md-0">
                      <button class="btn btn-sm btn-outline-light dropdown-toggle text-dark" type="button"
                        id="dropdownMenuDate1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        2018
                      </button>
                ...
                <div class="row">
                  <div class="col-md-7 col-lg-6 col-xl-7">
                    <div class="card-body h-100 d-flex flex-column">
                      ...
                      <p class="text-muted mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia id beatae
                  ...
                  <div class="col-md-5 col-lg-6 col-xl-5">
                    <div class="card-body">
                      ...
                      <div class="d-flex mb-3">
                        <i class="mdi mdi-arrow-expand-up mb-0 text-success me-2 mt-1"></i>
                        <p class="mb-0 text-dark">15% more than last week</p>
                      </div>
                      <div class="d-flex flex-wrap mb-5">
                        <button class="btn btn-info mt-3 me-2">Update</button>
                    ...
                    <table class="table table-striped">
                      <thead>
                        <tr class="border-top-0">
                          ...
                          <th class="text-muted">Purchased Price</th>
